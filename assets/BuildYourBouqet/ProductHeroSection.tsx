...
const heroContent = {
  ...
  backgroundImage:
    "https://c.animaapp.com/mp18tsxfgJ0g8r/img/hero-section-1.png",
...
export const ProductHeroSection = (): JSX.Element => {
  return (
    <section className="mt-6 w-full px-6">
      <Card className="overflow-hidden rounded-3xl border-0 bg-transparent shadow-none">
        <CardContent className="relative min-h-[212px] p-0 sm:min-h-[245px] lg:min-h-[285px]">
          <div
          ...
          <div
            ...
            aria-hidden="true"
          />
          <div className="relative z-10 flex h-full min-h-[212px] flex-col justify-between p-8 sm:min-h-[245px] sm:p-10 lg:min-h-[285px]">
            <button
              type="button"
            ...
            <header className="max-w-[520px]">
              ...
              <h1 className="mt-1 [font-family:'Playfair_Display',Helvetica] text-[40px] font-medium leading-none tracking-[0] text-white sm:text-[48px] lg:text-[54px]">
                {heroContent.title}
              </h1>
            </header>
          </div>
