...
export const CinemaHeroSection = (): JSX.Element => {
  ...
  return (
    <section
      ...
      aria-label="Cinema hero section"
    >
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(13,3,23,1)_0%,rgba(55,12,100,0.82)_42%,rgba(55,12,100,0.34)_55%,rgba(13,3,23,0)_100%)]" />
        ...
        <nav aria-label="Back navigation">
          ...
          >
            <span className="inline-flex items-center gap-2">
              <span className="flex h-6 w-6 items-center justify-center rounded-md bg-white sm:h-8 sm:w-8">
                <img
                  className="h-4 w-4"
                  alt="back"
