...
export const CAKE_OPTIONS = [
  { id: 'belgian-choc', name: 'Belgian Chocolate', price: 3500, image: 'https://c.animaapp.com/mp0xwaecNdkuMq/img/21765-1-4.png' },
  { id: 'red-velvet', name: 'Red Velvet', price: 3800, image: 'https://c.animaapp.com/mp0xwaecNdkuMq/img/21765-1-5.png' },
  { id: 'pistachio-rose', name: 'Pistachio Rose', price: 5000, image: 'https://c.animaapp.com/mp0xwaecNdkuMq/img/21765-1-8.png' },
  { id: 'carrot-walnut', name: 'Carrot & Walnut', price: 5000, image: 'https://c.animaapp.com/mp0xwaecNdkuMq/img/21765-1-9.png' },
];
...
type Props = {
  ...
  onCakeChange: (id: string | null) => void;
  runningTotal: number;
};

export function SmallEventStep2Modal({
  visible, onClose, onBack, onNext,
  packageTitle, packageImage,
  selectedCakeId, onCakeChange,
  runningTotal,
}: Props) {
          ...
          >
            <View style={{ flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', gap: t(16, 12) }}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.8}
                style={{
                  width: t(24, 20), height: t(24, 20), borderRadius: t(12, 10),
                  backgroundColor: '#ffffff', alignItems: 'center', justifyContent: 'center',
                  shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 3, flexShrink: 0,
                }}
              >
            ...
            <View style={{ flexDirection: 'row', gap: t(10, 8), marginTop: t(20, 16) }}>
              {[0, 1, 2, 3, 4].map((i) => (
                <View key={i} style={{ flex: 1, height: t(6, 5), borderRadius: 30, backgroundColor: i <= 1 ? '#775596' : 'rgba(110,110,110,0.22)' }} />
              ))}
            </View>
          </View>

          {/* Body */}
          <ScrollView showsVerticalScrollIndicator={false} bounces={false} contentContainerStyle={{ paddingHorizontal: t(40, 24), paddingTop: t(20, 16), paddingBottom: t(8, 6) }}>
            ...
            <TouchableOpacity
              activeOpacity={0.8}
              onPress={() => onCakeChange(null)}
              style={{
                flexDirection: 'row',
                alignItems: 'center',
                gap: t(12, 10),
                borderWidth: 1,
                borderColor: selectedCakeId === null ? '#775596' : 'rgba(110,110,110,0.2)',
                backgroundColor: selectedCakeId === null ? 'rgba(119,85,150,0.06)' : 'rgba(223,223,223,0.26)',
                borderRadius: t(10, 8),
            ...
            >
              <Text style={{ flex: 1, fontFamily: 'Montserrat_500Medium', fontSize: t(15, 12), color: '#1e1e1e' }}>No cake</Text>
              <Text style={{ fontFamily: 'Montserrat_500Medium', fontSize: t(15, 12), color: '#6e6e6e' }}>—</Text>
            </TouchableOpacity>
